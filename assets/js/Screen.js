...
<section class="choosePoke">
    <div class="character" data-pokemolle="${carapuce.nom}">
        <div class="character__image"><img src="../assets/img/Pokemolle/${carapuce.home}" alt=""></div>
        <h2>${carapuce.nom}</h2>
    </div>
    <div class="character" data-pokemolle="${bulbizar.nom}">
        <div class="character__image"><img src="../assets/img/Pokemolle/${bulbizar.home}" alt="""></div>
        <h2>${bulbizar.nom}</h2>
    </div>
    <div class="character" data-pokemolle="${salameche.nom}">
    <div class="character__image"><img src="../assets/img/Pokemolle/${salameche.home}" alt=""></div>
        <h2>${salameche.nom}</h2>
    </div>
</section>`;